    ...
    var body: some View{
        ZStack{
            ...
            ZStack{
                ...
                Text("He was losing hope when… He finally spotted a planet that had his blue skin color: the Earth!")
...
//                .position(x:-85, y: 140)
            ...
            ZStack{
                Rectangle()
                    ...
                    .frame(width: 625, height: 90)
                    .position(x:350, y:325)
                Text("He decided to dock right on it. He landed near a farm in the middle of the night, hiding his Spaceship in the brushwood.")
                    .foregroundColor(.white)
                    .font(.body)
                    .frame(width: 600, height: 100)
                    .position(x:350, y: 325)
        ...
        ZStack{
            ...
            ZStack{
                Rectangle()
                    ...
                    .frame(width: 625, height: 90)
                    .position(x:350, y:325)
                Text("In the Spacescip, Ascion noticed a strange object:  the Nebulizer Gun. He used it to take the form of a human being.")
                    .foregroundColor(.white)
                    .font(.body)
                    .frame(width: 600, height: 100)
                    .position(x:350, y: 325)
